...
//  UARTprintf("\033[2J");
  ...
  ROM_GPIOPinTypeGPIOOutput(GPIO_PORTF_AHB_BASE, RED_LED|BLUE_LED|GREEN_LED);
  GPIOPadConfigSet(GPIO_PORTF_AHB_BASE, GREEN_LED, GPIO_STRENGTH_8MA, GPIO_PIN_TYPE_STD);
...
//  usprintf(LN2,"ID1=%02X",id1);
  ...
  while (1) 
  {
    HWREG(GPIO_PORTF_AHB_BASE | (GREEN_LED << 2)) = GREEN_LED;
    HWREG(GPIO_PORTF_AHB_BASE | (GREEN_LED << 2)) = 0;    
    HWREG(GPIO_PORTF_AHB_BASE | (GREEN_LED << 2)) = GREEN_LED;
    HWREG(GPIO_PORTF_AHB_BASE | (GREEN_LED << 2)) = 0;    
    HWREG(GPIO_PORTF_AHB_BASE | (GREEN_LED << 2)) = GREEN_LED;
    HWREG(GPIO_PORTF_AHB_BASE + (GREEN_LED << 2)) = 0;    
