...
//  N93_rainbow_zx();
  ...
  ili9481_putstr("LCD",158,46,BIG_FONT,PINK_COLOR,CYAN_COLOR);
  ili9481_putstr("Colour",110,46,MEDIUM_FONT,RED_COLOR,ORANGE_COLOR);
  ili9481_putstr("Temperature",55,86,BIG_FONT,BLUE_COLOR,TRANSPARENT);
  ili9481_putstr("ILI9481 CONTROLLER",2,124,SMALL_FONT,WHITE_COLOR,TRANSPARENT);
