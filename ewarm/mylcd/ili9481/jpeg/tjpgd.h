...
struct JDEC {
  ...
  unsigned int (*infunc)(JDEC*, BYTE*, unsigned int); // Pointer to jpeg stream input function
  void* device;         // Pointer to I/O device identifiler for the session
};

// TJpgDec API functions
unsigned char jd_prepare (JDEC*, unsigned int(*)(JDEC*,BYTE*,unsigned int), void*, unsigned int, void*);
unsigned char jd_decomp (JDEC*, unsigned int(*)(JDEC*,void*,JRECT*), BYTE);
unsigned char out_jpg (unsigned int x, unsigned int y, const char *filename);
