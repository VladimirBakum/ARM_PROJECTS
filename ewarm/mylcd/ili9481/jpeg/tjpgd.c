...
{
  (WORD)(1.00000*8192), (WORD)(1.38704*8192), (WORD)(1.30656*8192), 
  (WORD)(1.17588*8192), (WORD)(1.00000*8192), (WORD)(0.78570*8192), 
  (WORD)(0.54120*8192), (WORD)(0.27590*8192),
  (WORD)(1.38704*8192), (WORD)(1.92388*8192), (WORD)(1.81226*8192), 
  (WORD)(1.63099*8192), (WORD)(1.38704*8192), (WORD)(1.08979*8192), 
  (WORD)(0.75066*8192), (WORD)(0.38268*8192),
  (WORD)(1.30656*8192), (WORD)(1.81226*8192), (WORD)(1.70711*8192), 
  (WORD)(1.53636*8192), (WORD)(1.30656*8192), (WORD)(1.02656*8192), 
  (WORD)(0.70711*8192), (WORD)(0.36048*8192),
  (WORD)(1.17588*8192), (WORD)(1.63099*8192), (WORD)(1.53636*8192), 
  (WORD)(1.38268*8192), (WORD)(1.17588*8192), (WORD)(0.92388*8192), 
  (WORD)(0.63638*8192), (WORD)(0.32442*8192),
  (WORD)(1.00000*8192), (WORD)(1.38704*8192), (WORD)(1.30656*8192), 
  (WORD)(1.17588*8192), (WORD)(1.00000*8192), (WORD)(0.78570*8192), 
  (WORD)(0.54120*8192), (WORD)(0.27590*8192),
  (WORD)(0.78570*8192), (WORD)(1.08979*8192), (WORD)(1.02656*8192), 
  (WORD)(0.92388*8192), (WORD)(0.78570*8192), (WORD)(0.61732*8192), 
  (WORD)(0.42522*8192), (WORD)(0.21677*8192),
  (WORD)(0.54120*8192), (WORD)(0.75066*8192), (WORD)(0.70711*8192), 
  (WORD)(0.63638*8192), (WORD)(0.54120*8192), (WORD)(0.42522*8192), 
  (WORD)(0.29290*8192), (WORD)(0.14932*8192),
  (WORD)(0.27590*8192), (WORD)(0.38268*8192), (WORD)(0.36048*8192), 
  (WORD)(0.32442*8192), (WORD)(0.27590*8192), (WORD)(0.21678*8192), 
  (WORD)(0.14932*8192), (WORD)(0.07612*8192)
};
...
static unsigned int create_qt_tbl ( // 0:OK, !0:Failed
	JDEC* jd,                   // Pointer to the decompressor object
...
static unsigned int create_huffman_tbl (	/* 0:OK, !0:Failed */
	JDEC* jd,				/* Pointer to the decompressor object */
...
)
{
  const long M13 = (long)(1.41421*4096), 
             M2 = (long)(1.08239*4096), 
             M4 = (long)(2.61313*4096), 
...
/* Pointer to the decompressor object */
static unsigned char mcu_load (JDEC* jd)
{
...
//-----------------------------------------------------------------------
// Param:
// 1 - Blank decompressor object
// 2 - JPEG strem input function
// 3 - Working buffer for the decompression session
// 4 - Size of working buffer
// 5 - I/O device identifier for the session


#define	LDB_WORD(ptr) (WORD)(((WORD)*((BYTE*)(ptr))<<8)|(WORD)*(BYTE*)((ptr)+1))

unsigned char jd_prepare (JDEC* jd, unsigned int (*infunc)(JDEC*, BYTE*, unsigned int),
...
//-----------------------------------------------------------------------
// Param:
// 1 - Initialized decompression object
// 2- RGB output function
// Output de-scaling factor (0 to 3)

unsigned char jd_decomp (JDEC* jd, unsigned int (*outfunc)(JDEC*, void*, JRECT*), BYTE scale)
{
